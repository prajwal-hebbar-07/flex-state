...
//
// `requires` lists every equipment kind an exercise needs at once; a location
// can run it only when the location owns all of them.
// Difficulty enum: 'beginner' | 'intermediate' | 'advanced'.

export type EquipmentKind = "bodyweight" | "furniture" | "dumbbells" | "floor";
export type Difficulty = "beginner" | "intermediate" | "advanced";

export const EQUIPMENT_KINDS: EquipmentKind[] = ["bodyweight", "furniture", "dumbbells", "floor"];
...
export const EXERCISES: Exercise[] = [
  ...
  },
  {
    ...
    categorySlug: "back",
    requires: ["bodyweight", "furniture", "dumbbells"],
