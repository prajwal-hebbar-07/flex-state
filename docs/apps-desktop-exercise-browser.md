...
3. The equipment filter matches an exercise whose `equipment` equals the selection or is `both`.
...
9. No network, database, or Tauri calls; every input arrives through props.
